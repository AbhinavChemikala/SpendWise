    ...
    new_box = """Box(
                ...
                Canvas(
                    modifier = Modifier
                        ...
                        .androidx.compose.ui.input.pointer.pointerInput(trend) {
                            androidx.compose.foundation.gestures.detectDragGestures(
                                ...
                                val index = kotlin.math.round(xPos / widthStep).toInt().coerceIn(0, trend.lastIndex)
                                hoveredIndex = index
                            }
                        }
                        .androidx.compose.ui.input.pointer.pointerInput(trend) {
